...
#define MYLOG_S(Verbosity) UE_LOG(MyGame, Verbosity, TEXT("%s"), *MYLOG_CALLINFO)
#define MYLOG(Verbosity, Format, ...) UE_LOG(MyGame, Verbosity, TEXT("%s %s"), *MYLOG_CALLINFO, *FString::Printf(Format, ##__VA_ARGS__))
